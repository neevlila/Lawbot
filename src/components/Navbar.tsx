  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-2 bg-light-card/80 dark:bg-dark-card/80 p-1 rounded-full border border-light-border dark:border-dark-border smooth-transition">
