...
const FeaturesPage: React.FC = () => {
  useEffect(() => {
    document.title = 'AI Legal Assistant — Features';
    const desc = document.querySelector('meta[name="description"]');
    if (desc) desc.setAttribute('content', 'Features: Document summarization, case analytics, contextual chat history, team collaboration and more.');
  }, []);
